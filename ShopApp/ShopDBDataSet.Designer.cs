...
namespace ShopApp {
    ...
    public partial class ShopDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(int ID, double Price, string Name, int InStock, string Category) {
        ...
        public partial class PaymentsDataTable : global::System.Data.TypedTableBase<PaymentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PaymentsRow AddPaymentsRow(int Id, int Quantity, double Value, string Name, System.DateTime Date, string Category) {
        ...
        public partial class ItemsRow : global::System.Data.DataRow {
            ...
            public int InStock {
                get {
                    return ((int)(this[this.tableItems.InStockColumn]));
                }
                set {
                    this[this.tableItems.InStockColumn] = value;
                }
            }
        ...
        public partial class PaymentsRow : global::System.Data.DataRow {
            ...
            public double Value {
                get {
                    return ((double)(this[this.tablePayments.ValueColumn]));
                }
                set {
            ...
            public string Category {
                get {
                    return ((string)(this[this.tablePayments.CategoryColumn]));
                }
                set {
                    this[this.tablePayments.CategoryColumn] = value;
                }
            }
        }
...
namespace ShopApp.ShopDBDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([ID] = @Original_ID) AND ([Price] = @Original_P" +
                "rice) AND ([InStock] = @Original_InStock))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([ID], [Price], [Name], [InStock], [Category]) VALUES (" +
                "@ID, @Price, @Name, @InStock, @Category);\r\nSELECT ID, Price, Name, InStock, Cate" +
                "gory FROM Items WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ID] = @ID, [Price] = @Price, [Name] = @Name, [InStock] = @InStock, [Category] = @Category WHERE (([ID] = @Original_ID) AND ([Price] = @Original_Price) AND ([InStock] = @Original_InStock));
SELECT ID, Price, Name, InStock, Category FROM Items WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ShopApp.Properties.Settings.Default.ShopDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Price, Name, InStock, Category FROM dbo.Items";
        ...
        public virtual int Fill(ShopDBDataSet.ItemsDataTable dataTable) {
        ...
        public virtual ShopDBDataSet.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDBDataSet.ItemsDataTable dataTable = new ShopDBDataSet.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDBDataSet.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, double Original_Price, int Original_InStock) {
        ...
        public virtual int Insert(int ID, double Price, string Name, int InStock, string Category) {
        ...
        public virtual int Update(int ID, double Price, string Name, int InStock, string Category, int Original_ID, double Original_Price, int Original_InStock) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_InStock));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(double Price, string Name, int InStock, string Category, int Original_ID, double Original_Price, int Original_InStock) {
            return this.Update(Original_ID, Price, Name, InStock, Category, Original_ID, Original_Price, Original_InStock);
        }
    }
    ...
    public partial class PaymentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Payments] WHERE (([Id] = @Original_Id) AND ([Quantity] = @Orig" +
                "inal_Quantity) AND ([Value] = @Original_Value) AND ([Name] = @Original_Name) AND" +
                " ([Date] = @Original_Date) AND ([Category] = @Original_Category))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payments] ([Id], [Quantity], [Value], [Name], [Date], [Categor" +
                "y]) VALUES (@Id, @Quantity, @Value, @Name, @Date, @Category);\r\nSELECT Id, Quanti" +
                "ty, Value, Name, Date, Category FROM Payments WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payments] SET [Id] = @Id, [Quantity] = @Quantity, [Value] = @Value, [Name] = @Name, [Date] = @Date, [Category] = @Category WHERE (([Id] = @Original_Id) AND ([Quantity] = @Original_Quantity) AND ([Value] = @Original_Value) AND ([Name] = @Original_Name) AND ([Date] = @Original_Date) AND ([Category] = @Original_Category));
SELECT Id, Quantity, Value, Name, Date, Category FROM Payments WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Quantity, Value, Name, Date, Category FROM dbo.Payments";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ShopDBDataSet.PaymentsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ShopDBDataSet.PaymentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopDBDataSet.PaymentsDataTable dataTable = new ShopDBDataSet.PaymentsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopDBDataSet.PaymentsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, int Original_Quantity, double Original_Value, string Original_Name, System.DateTime Original_Date, string Original_Category) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, int Quantity, double Value, string Name, System.DateTime Date, string Category) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, int Quantity, double Value, string Name, System.DateTime Date, string Category, int Original_Id, int Original_Quantity, double Original_Value, string Original_Name, System.DateTime Original_Date, string Original_Category) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Quantity, double Value, string Name, System.DateTime Date, string Category, int Original_Id, int Original_Quantity, double Original_Value, string Original_Name, System.DateTime Original_Date, string Original_Category) {
            return this.Update(Original_Id, Quantity, Value, Name, Date, Category, Original_Id, Original_Quantity, Original_Value, Original_Name, Original_Date, Original_Category);
        }
    }
